...
public class RobotMap {
	...
	// limit switches
	public static final int ROLLER_SWITCH_LEFT 		= 0;
	public static final int ROLLER_SWITCH_RIGHT 	= 1;
    ...
    public static final int EXTEND_PORT_A			= 0;
    public static final int EXTEND_PORT_B			= 0;
    
    public static final int MOVE_PORT_A				= 0;
    public static final int MOVE_PORT_B				= 0;
